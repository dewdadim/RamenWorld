<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="RamenWorld.login" %>
...
<body>
	...
	<article class="card-body mx-auto" style="width: 500px;">
		...
		<p class="text-center">Welcome back for the best ramen world!</p>
		<h4 class="card-title mt-5 mb-3 text-center">Login</h4>
		<form id="form1" runat="server">
			...
			<p class="text-center">A new customer? <a href="register.aspx">Register</a> </p>                                                                 
		</form>
	</article>
	</div>
</body>
